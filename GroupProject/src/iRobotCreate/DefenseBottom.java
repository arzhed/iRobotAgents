 ...
 *
 */
public class DefenseBottom extends StateBasedController {
	 ...
	 * @throws Exception
	 */
	public DefenseBottom(ParamsMap params, AgentUI ui) throws Exception {
		super(params, ui);
			...
			makeSubthread(new Runnable() {
				...
				public void run() {
					try {
                        ...
                        Position posTri = askCamera("triangle", myColor);
						turnAngle = posTri.a - getAngle(posTri.x, 700, posTri.x, posTri.y);
						...
						while (posTri.y<700 - (int)iRobotCommands.chassisRadius - 20){
